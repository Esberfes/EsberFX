...
public class TreeBuilder {
    ...
    public static final String EVT_EDITED = "EVT_EDITED";

    public TreeBuilder(TreeTableView<Object> treeTableView) {
        this.treeTableView = treeTableView;
        support = new PropertyChangeSupport(treeTableView);
        setupTree();
    }
    ...
    private void setupTree() {
        ...
        columnValue.setOnEditCommit(new EventHandler<TreeTableColumn.CellEditEvent<Object, Object>>() {
            ...
            public void handle(TreeTableColumn.CellEditEvent<Object, Object> objectObjectCellEditEvent) {
                ...
                JSONObject old = ((JSONHolder) treeTableView.getRoot().getValue()).getJSONObject();
                JSONObject newJson = new JSONObject(old.toString());

                support.firePropertyChange(EVT_EDITED, null, newJson);
            }
        });
    }
