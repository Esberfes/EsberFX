package com.esberfes.plugin.impl.elasticsearch.component.toolbar.data.tree;
...
public class EditingCell extends TreeTableCell<Object, Object> {
    ...
    public void startEdit() {
        ...
        Object parent = null;
        if (getTreeTableRow().getItem() instanceof com.esberfes.plugin.impl.elasticsearch.component.toolbar.data.tree.JSONValue) {
            parent = ((com.esberfes.plugin.impl.elasticsearch.component.toolbar.data.tree.JSONValue)getTreeTableRow().getItem()).getParent();
            if (column == COLUMN_VALUE) {
                // Can always edit values.
                canEdit = true;
            }
        } else if (getTreeTableRow().getItem() instanceof com.esberfes.plugin.impl.elasticsearch.component.toolbar.data.tree.JSONHolder && column == COLUMN_KEY) {
            final com.esberfes.plugin.impl.elasticsearch.component.toolbar.data.tree.JSONHolder jsonHolder = (com.esberfes.plugin.impl.elasticsearch.component.toolbar.data.tree.JSONHolder) getTreeTableRow().getItem();
